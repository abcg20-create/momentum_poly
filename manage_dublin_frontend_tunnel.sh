...
RUNNER_PATH="${ROOT_DIR}/run_dublin_frontend_tunnel.sh"
LABEL="${LAUNCHD_LABEL:-com.polymarket.dublin-frontend-tunnel}"
PLIST_DIR="${HOME}/Library/LaunchAgents"
PLIST_PATH="${PLIST_DIR}/${LABEL}.plist"
OUT_LOG="${OUT_LOG:-/tmp/polymarket_dublin_frontend_tunnel.out.log}"
ERR_LOG="${ERR_LOG:-/tmp/polymarket_dublin_frontend_tunnel.err.log}"
