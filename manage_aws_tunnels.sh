...
RUNNER_PATH="${ROOT_DIR}/run_aws_tunnels.sh"
LABEL="${LAUNCHD_LABEL:-com.polymarket.aws-tunnels}"
PLIST_DIR="${HOME}/Library/LaunchAgents"
PLIST_PATH="${PLIST_DIR}/${LABEL}.plist"
OUT_LOG="${OUT_LOG:-/tmp/polymarket_aws_tunnels.out.log}"
ERR_LOG="${ERR_LOG:-/tmp/polymarket_aws_tunnels.err.log}"
