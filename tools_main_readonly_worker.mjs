...
const WORKER_LABEL = String(process.env.WORKER_LABEL || "main-readonly").trim() || "main-readonly";
...
const WORKER_SCOPE = String(process.env.WORKER_SCOPE || "main").trim().toLowerCase() || "main";
